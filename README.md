...
## ar_track_alvar (kinetic) - 0.7.1-0

The packages in the `ar_track_alvar` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic ar_track_alvar --edit` on `Wed, 14 Jun 2017 21:49:48 -0000`
...
## ar_track_alvar (kinetic) - 0.7.0-2

The packages in the `ar_track_alvar` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic ar_track_alvar` on `Wed, 14 Jun 2017 21:45:09 -0000`
...
## ar_track_alvar (kinetic) - 0.7.0-1

The packages in the `ar_track_alvar` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic ar_track_alvar` on `Wed, 26 Apr 2017 22:09:02 -0000`
...
## ar_track_alvar (kinetic) - 0.7.0-0

The packages in the `ar_track_alvar` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic ar_track_alvar` on `Wed, 26 Apr 2017 21:54:21 -0000`
...
## ar_track_alvar (lunar) - 0.7.0-0

The packages in the `ar_track_alvar` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar ar_track_alvar` on `Wed, 26 Apr 2017 21:19:24 -0000`
...
## ar_track_alvar (jade) - 0.5.6-0

The packages in the `ar_track_alvar` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade ar_track_alvar` on `Thu, 09 Feb 2017 10:46:22 -0000`
...
## ar_track_alvar (indigo) - 0.5.6-0

The packages in the `ar_track_alvar` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo ar_track_alvar` on `Thu, 09 Feb 2017 10:44:19 -0000`
...
## ar_track_alvar (indigo) - 0.5.5-0

The packages in the `ar_track_alvar` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo ar_track_alvar` on `Wed, 08 Feb 2017 01:14:43 -0000`
...
## ar_track_alvar (jade) - 0.5.4-0

The packages in the `ar_track_alvar` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade ar_track_alvar` on `Mon, 26 Sep 2016 20:59:01 -0000`
